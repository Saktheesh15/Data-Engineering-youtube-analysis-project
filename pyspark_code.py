...
## @type: DataSource
## @args: [database = "data-engineer-on-youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
############################### Added by Saktheesh ###############################
predicate_pushdown = "region in ('ca','gb','us')"

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "data-engineer-on-youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://data-engineer-on-youtube-cleansed-useast1-development/youtube/raw_statistics/"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://data-engineer-on-youtube-cleansed-useast1-development/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
